...
ingestion_test_pickle_path = '../output/ingest_test_df.pkl'
transformation_pickle_path = '../output/transformation_df.pkl'
feature_engineering_pickle_path = '../output/fe_df.pkl'


def main():
    ingest(csv_path, ingestion_train_pickle_path,ingestion_test_pickle_path)
    transform(ingestion_train_pickle_path, transformation_pickle_path)
